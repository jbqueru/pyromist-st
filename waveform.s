...
wave_compute:
	...
	move.l	#wave_y1,front_drawn_data
	move.l	#wave_y2,front_to_draw_data
	move.l	#wave_y3,back_drawn_data
	move.l	#wave_y4,back_to_draw_data
	move.l	back_to_draw_data,most_recently_updated
	move.l	back_to_draw_data,next_to_update

	lea.l	heap,a0
	lea.l	wave_slices,a1
	moveq.l	#11,d0
.l0:
	moveq.l	#31,d1
	move.w	(a1)+,d5
